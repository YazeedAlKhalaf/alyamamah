...
import './time_planner_style.dart';
import './time_planner_task.dart';
import './time_planner_time.dart';
import './time_planner_title.dart';
                                ...
                                children: <Widget>[
                                  SizedBox(
                                    height: (config.totalHours *
                                        ...
                                        80,
                                    width:
                                        (config.totalDays * config.cellWidth!)
                                            .toDouble(),
                                    child: Stack(
                                      children: <Widget>[
                                        Column(
